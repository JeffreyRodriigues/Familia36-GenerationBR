...
@Entity //Criando uma tabela no banco
@Table(name = "tb_produtos") //CREATE DATABASE tb_produtos.  OBS: Se não houver um nome, pega o nome da classe.
public class Produto {
	...
	@ManyToOne //relacionamento muitos para um, produtos da categoria.
