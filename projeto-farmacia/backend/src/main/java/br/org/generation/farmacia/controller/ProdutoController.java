...
@RestController //Manda requisição, processa e responde | Não guarda informações
@RequestMapping("/produtos") //Definindo qual classe você esta solicitando, o endereço do recurso
@CrossOrigin(origins = "*", allowedHeaders = "*") //liberdade para hospedagem do front-end
