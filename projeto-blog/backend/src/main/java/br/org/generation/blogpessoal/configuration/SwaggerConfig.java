...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				.title("Blog - Receitas do Jeff")
				.description("Receitas do Jeff - Blog Pessoal")
				.version("1.0.0")
				.license("Apache License Version 2.0")
				.licenseUrl("https://github.com/jeffreyrodriigues")
				.contact(contact())
				.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Jeffrey Rodrigues", "https://github.com/jeffreyrodriigues", "jeffreyrodriigues@gmail.com");
	}
